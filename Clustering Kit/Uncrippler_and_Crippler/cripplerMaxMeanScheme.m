function cripplerMaxMeanScheme()
...
hgexport(f,strcat(sprintf('currStep_%i',currStep),'_meanclassifscore.png'),...
...
set(gcf,'units','normalized','outerposition',[0 0 1 1])
hgexport(h,strcat(sprintf('currStep_%i',currStep),'_minclassifscore.png'),...
                                 hgexport('factorystyle'),'Format','png');
